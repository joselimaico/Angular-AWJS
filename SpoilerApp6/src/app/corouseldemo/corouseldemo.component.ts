...
@Component({
  selector: 'app-corouseldemo',
  templateUrl: './corouseldemo.component.html',
  styleUrls: ['./corouseldemo.component.css']
})
export class CorouseldemoComponent implements OnInit {
